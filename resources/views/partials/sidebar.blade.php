      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children">
          ...
          <ul id="ddmenu_2" class="collapse {{ request()->is(['product', 'product/*'], ['category', 'category/*'], ['customer', 'customer/*'], ['cashier', 'cashier/*'], ['kitchen', 'kitchen/*']) ? 'show' : '' }} dropdown-nav">
            ...
            <li>
              <a href="/customer" class="@if(Request::segment(1) === 'customer') active @endif"> Customer </a>
            </li>
            <li>
              <a href="/cashier" class="@if(Request::segment(1) === 'cashier') active @endif"> Cashier </a>
            </li>
            <li>
              <a href="/kitchen" class="@if(Request::segment(1) === 'kitchen') active @endif"> Kitchen </a>
            </li>
          </ul>
        </li>
