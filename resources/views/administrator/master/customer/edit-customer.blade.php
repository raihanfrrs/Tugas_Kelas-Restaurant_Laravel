...
<div class="form-elements-wrapper">
    ...
    <div class="col-lg-6">
        ...
        <h6 class="mb-25">Customer Form</h6>
        <div class="input-style-1">
            <label for="customer">Customer Name</label>
            <input type="text" class="@error('name') is-invalid @enderror text-capitalize" placeholder="Customer Name" name="name" id="customer" value="{{ old('name', $customer->name) }}" required/>
            @error('customer')
