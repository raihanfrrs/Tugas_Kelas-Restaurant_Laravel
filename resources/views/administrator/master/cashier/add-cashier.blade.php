...
<div class="form-elements-wrapper">
    <form action="/cashier" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
    <div class="col-lg-6">
        <!-- input style start -->
        <div class="card-style mb-30">
            ...
            <div class="input-style-1">
                ...
                <input type="text" class="@error('name') is-invalid @enderror text-capitalize" placeholder="Cashier Name" name="name" id="cashier" value="{{ old('name') }}" required/>
                @error('name')
    ...
    <div class="col-lg-6">
        ...
        <div class="input-style-1">
            ...
            <input type="file" class="@error('image') is-invalid @enderror" placeholder="Cashier Picture" name="image" id="image" onchange="previewImage()" required/>
            @error('image')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
