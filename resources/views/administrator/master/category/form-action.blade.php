<form action="category/{{ $model->slug }}" method="post">
    @csrf
    @method('delete')
    <a href="category/{{ $model->slug }}/edit" class="text-decoration-none text-warning">
    ...
    <a href="category/{{ $model->slug }}" class="text-decoration-none text-success">
        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
